 ...
 *
 * Legacy rows carry only `randomize_time`; resolve via resolveRandomizeMode()
 * (randomize_time === true → 'fleet', else 'fixed').
 */
...
export interface Schedule {
  ...
  target_index: string | null;
  /**
   * Per-agent next-run times for `per_machine` randomization, keyed by agent id.
